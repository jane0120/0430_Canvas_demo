/**
 * Created by jianyujing on 2016/4/18.
 * ctrl+alt +L;自动整理格式
 *
 *
 *
...
function drawGrid(color, stepx, stepy) {
    ...
    function updateRubberbandRectangle(loc) {
        ...
        if (loc.x > mousedown.x) rubberbandRect.left = mousedown.x; else       rubberbandRect.left = loc.x;
        if (loc.y > mousedown.y) rubberbandRect.top = mousedown.y; else        rubberbandRect.top = loc.y;
    }

    function drawBezierCurve() {
        context.beginPath();
        context.moveTo(endPoints[0].x, endPoints[0].y);
        context.bezierCurveTo(controlPoints[0].x, controlPoints[0].y, controlPoints[1].x, controlPoints[1].y, endPoints[1].x, endPoints[1].y);//3次贝塞尔曲线
        context.stroke();
    }
...
// Canvas event handlers..............................................
        ...
        canvas.onmousemove = function (e) {
            ...
            if (dragging || draggingPoint) {
                e.preventDefault(); // Prevent selections restoreDrawingSurface();
                if (guidewires) {
        ...
        canvas.onmouseup = function (e) {
            ...
            if (!editing) {
                ...
                if (draggingPoint) drawControlAndEndPoints(); else               editing = false;
                drawBezierCurve();
